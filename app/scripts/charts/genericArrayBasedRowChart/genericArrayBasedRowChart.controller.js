(function() {
  ...
  function GenericArrayBasedRowChart($element, $attrs, $stateParams, $state, d3, dc, NdxService, NdxHelperFunctions, estepConf) {
    var ctrl = this;
    ...
    rowChart
      ...
      .filterHandler(function(dimension, filters) {
          var result = NdxHelperFunctions.bagORFilterHandler(rowChart, ctrl.chartHeader)(dimension, filters);
          var params = {};
