(function() {
  ...
  function ProjectsNdxService($q, crossfilter, DataService, Messagebus) {
    this.ndx = {};
    this.dimensions = [];
    ...
    this.readData = function(data) {
      ...
      this.ndx = crossfilter(data.project);
  ...
  angular.module('estepApp.projects').service('ProjectsNdxService', ProjectsNdxService);
})();
