(function() {
  ...
  function ProjectsExpertiseController($window, d3, dc, ProjectsNdxService, NdxHelperFunctions, estepConf) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_projects_expertise');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(ProjectsNdxService, 'expertise');
      var group = NdxHelperFunctions.buildGroupWithArrayProperty(dimension, 'expertise');
  ...
  angular.module('estepApp.software').controller('ProjectsExpertiseController', ProjectsExpertiseController);
})();
