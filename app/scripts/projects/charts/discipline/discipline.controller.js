(function() {
  ...
  function ProjectsDisciplineController($window, d3, dc, ProjectsNdxService, NdxHelperFunctions, estepConf) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_projects_discipline');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(ProjectsNdxService, 'discipline');
      var group = NdxHelperFunctions.buildGroupWithArrayProperty(dimension, 'discipline');
  ...
  angular.module('estepApp.projects').controller('ProjectsDisciplineController', ProjectsDisciplineController);
})();
