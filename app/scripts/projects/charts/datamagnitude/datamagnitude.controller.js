(function() {
  ...
  function ProjectsDataMagnitudeController($window, d3, dc, ProjectsNdxService, NdxHelperFunctions, estepConf) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_projects_datamagnitude');

      var dimension = NdxHelperFunctions.buildDimensionWithProperty(ProjectsNdxService, 'dataMagnitude');
      var group = NdxHelperFunctions.buildGroupWithProperty(dimension, 'dataMagnitude');
  ...
  angular.module('estepApp.projects').controller('ProjectsDataMagnitudeController', ProjectsDataMagnitudeController);
})();
