(function() {
  ...
  function ProjectsDataFormatController($window, d3, dc, ProjectsNdxService, NdxHelperFunctions, estepConf) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_projects_dataformat');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(ProjectsNdxService, 'dataFormat');
      var group = NdxHelperFunctions.buildGroupWithArrayProperty(dimension, 'dataFormat');
  ...
  angular.module('estepApp.projects').controller('ProjectsDataFormatController', ProjectsDataFormatController);
})();
