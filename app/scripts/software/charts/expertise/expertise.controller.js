(function() {
  ...
  function ExpertiseController($element, d3, dc, SoftwareNdxService, NdxHelperFunctions) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_expertise');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(SoftwareNdxService, 'expertise');
  ...
  angular.module('estepApp.software').controller('ExpertiseController', ExpertiseController);
})();
