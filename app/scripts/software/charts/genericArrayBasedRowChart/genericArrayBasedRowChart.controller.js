(function() {
  ...
  function GenericArrayBasedRowChart($scope, $element, d3, dc, SoftwareNdxService, NdxHelperFunctions, estepConf) {
    this.initializeChart = function(element, chartHeader, jsonArrayFieldToChart, maxRows) {
      ...
      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(SoftwareNdxService, gABRCCtrl.jsonArrayFieldToChart);
  ...
  angular.module('estepApp.software').controller('GenericArrayBasedRowChart', GenericArrayBasedRowChart);
})();
