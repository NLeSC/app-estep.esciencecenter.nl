(function() {
  ...
  function ProgrammingLanguageController($element, d3, dc, SoftwareNdxService, NdxHelperFunctions) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_programminglanguage');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(SoftwareNdxService, 'programmingLanguage');
      var group = NdxHelperFunctions.buildGroupWithArrayProperty(dimension, 'programmingLanguage');
  ...
  angular.module('estepApp.software').controller('ProgrammingLanguageController', ProgrammingLanguageController);
})();
