(function() {
  ...
  function LicenseController($element, d3, dc, SoftwareNdxService, NdxHelperFunctions) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_license');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(SoftwareNdxService, 'license');
      var group = NdxHelperFunctions.buildGroupWithArrayProperty(dimension, 'license');
  ...
  angular.module('estepApp.software').controller('LicenseController', LicenseController);
})();
