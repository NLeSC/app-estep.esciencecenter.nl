(function() {
  ...
  function CompetenceController($element, d3, dc, SoftwareNdxService, NdxHelperFunctions) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_competence');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(SoftwareNdxService, 'competence');
  ...
  angular.module('estepApp.software').controller('CompetenceController', CompetenceController);
})();
