(function() {
  ...
  function DisciplineController($element, d3, dc, SoftwareNdxService, NdxHelperFunctions) {

    this.initializeChart = function() {
      var rowChart = dc.rowChart('#rowchart_discipline');

      var dimension = NdxHelperFunctions.buildDimensionWithArrayProperty(SoftwareNdxService, 'discipline');
  ...
  angular.module('estepApp.software').controller('DisciplineController', DisciplineController);
})();
